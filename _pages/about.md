...
I'm a Senior NLP Engineer at [Aveni](https://aveni.ai/), building [FinLLM](https://labs.aveni.ai/finllm/) - LLMs for the financial services domain. I work across the model creation pipeline - on data filtering, pre-training, fine-tuning, pruning and distillation, domain adaptation, evaluation, and retrieval-augmented generation.
